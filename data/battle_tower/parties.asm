...
; BattleTowerMons group 1
	...
	db KOFFING
	db FOCUS_BAND
	db SMOG, EXPLOSION, PAIN_SPLIT, SLUDGE_BOMB
	dw 0 ; OT ID
	bigdt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db YANMA
	db KINGS_ROCK
	db SUPERSONIC, SONICBOOM, BATON_PASS, AGILITY
	dw 0 ; OT ID
	bigdt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db SWINUB
	db QUICK_CLAW
	db ICY_WIND, MUD_SLAP, REST, SNORE
	dw 0 ; OT ID
	bigdt 1000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 3
	...
	db DORMARE
	db THICK_CLUB
	db HYPNOSIS, NIGHTMARE, DREAM_EATER, PSYCHIC_M
	dw 0 ; OT ID
	bigdt 27000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db MAGMORTAR
	db MIRACLEBERRY
	db FIRE_PUNCH, SMOG, THUNDER_PUNCH, FIRE_SPIN
	dw 0 ; OT ID
	bigdt 27000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 5
	...
	db LECTROLITE
	db MIRACLEBERRY
	db EXPLOSION, THUNDERBOLT, THUNDER_WAVE, HYPER_BEAM
	dw 0 ; OT ID
	bigdt 125000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db YANMEGA
	db SCOPE_LENS
	db ANCIENTPOWER, BATON_PASS, AGILITY, SWIFT
	dw 0 ; OT ID
	bigdt 125000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db HERCULASH
	db GOLD_BERRY
	db MEGAHORN, HORN_ATTACK, SEISMIC_TOSS, HARDEN
	dw 0 ; OT ID
	bigdt 125000 ; Exp
	; Stat exp
	bigdw 40000
...
; BattleTowerMons group 6
	...
	db TROPIPOD
	db GOLD_BERRY
	db SOLARBEAM, STOMP, ANCIENTPOWER, HYPER_BEAM
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db LECTROLITE
	db MINT_BERRY
	db REST, EXPLOSION, THUNDERBOLT, THUNDER_WAVE
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 7
	...
	db TROPIPOD
	db LEFTOVERS
	db SOLARBEAM, SYNTHESIS, ANCIENTPOWER, HYPER_BEAM
	dw 0 ; OT ID
	bigdt 343000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db LECTROLITE
	db GOLD_BERRY
	db THUNDERBOLT, EXPLOSION, THUNDER_WAVE, HYPER_BEAM
	dw 0 ; OT ID
	bigdt 343000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db MAMOSWINE
	db KINGS_ROCK
	db BLIZZARD, EARTHQUAKE, HAIL, REST
	dw 0 ; OT ID
	bigdt 343000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db MAGMORTAR
	db QUICK_CLAW
	db FLAMETHROWER, FIRE_PUNCH, THUNDERPUNCH, SMOG
	dw 0 ; OT ID
	bigdt 343000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db YANMEGA
	db GOLD_BERRY
	db AGILITY, BATON_PASS, SWIFT, ANCIENTPOWER
	dw 0 ; OT ID
	bigdt 343000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 8
	...
	db TROPIPOD
	db MIRACLEBERRY
	db SYNTHESIS, SOLARBEAM, ANCIENTPOWER, SUNNY_DAY
	dw 0 ; OT ID
	bigdt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db WHELKANO
	db CHARCOAL
	db FLAMETHROWER, IRON_TAIL, SMOG, HYPER_BEAM
	dw 0 ; OT ID
	bigdt 512000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 9
	...
	db TROPIPOD
	db QUICK_CLAW
	db HYPER_BEAM, SOLARBEAM, SUNNY_DAY, ANCIENTPOWER
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 10
	...
	db GASSPING
	db FOCUS_BAND
	db SLUDGE_BOMB, EXPLOSION, TOXIC, PSYCHIC_M
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
	; Stat exp
	bigdw 45000
