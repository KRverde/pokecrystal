...
FalknerGroup:
	...
	db  9, HOOTHOOT,   TACKLE, MUD_SLAP, NO_MOVE, NO_MOVE
	db  10, NOCTOWL,   TACKLE, MUD_SLAP, GUST, NO_MOVE
	db -1 ; end
...
WhitneyGroup:
	...
	db 19, SNUBBULL,   BITE, CHARM, SCARY_FACE, TACKLE
...
BugsyGroup:
	...
	db 15, KABUTO,     SCRATCH, HARDEN, ABSORB, NO_MOVE
	db 16, SCIZOR,     QUICK_ATTACK, LEER, FURY_CUTTER, PURSUIT
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_MOVES
	db 21, HAUNTER,    HYPNOSIS, NIGHTMARE, CURSE, NIGHT_SHADE
	db 23, GENGAR,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 25, PERISHROOM, SPORE, FURY_CUTTER, PURSUIT, SHADOW_BALL
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 33, DELIBIRD,   PRESENT, REST, ICY_WIND, FLY
	db 34, DEWGONG,    HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 35, SNEASEL,    FAINT_ATTACK, ICY_WIND, FURY_SWIPES, SCREECH
	db 36, GLACEON,    MIRROR_COAT, HAIL, ICY_WIND, BITE
...
JasmineGroup:
	...
	db 30, OMANYTE,    WATER_GUN, BITE, CONSTRICT, AURORA_BEAM
	db 31, MAGNETON,   THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 32, SKARMORY,   STEEL_WING, SWIFT, PECK, AGILITY
...
ChuckGroup:
	...
	db 27, MACHOKE,    LEER, FORESIGHT, KARATE_CHOP, SEISMIC_TOSS
	db 28, HITMONTOP,  RAPID_SPIN, ROLLING_KICK, PURSUIT, QUICK_ATTACK
	db 29, HERACROSS,  FURY_ATTACK, FURY_CUTTER, ROCK_SMASH, LEER
...
ClairGroup:
	...
	db 37, SEADRA,     TWISTER, SURF, AURORA_BEAM, DRAGONBREATH
	db 37, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, SLAM, DRAGONBREATH
	db 37, ARBOK,      GLARE, SCREECH, SLAM, ACID
	db 39, TROPIUS,    STOMP, MAGICAL_LEAF, BODY_SLAM, GUST
	db 40, KINGDRA,    OCTAZOOKA, SURF, HYPER_BEAM, DRAGONBREATH
	db -1 ; end
...
WillGroup:
	...
	db 40, XATU,       TWISTEDSPOON, QUICK_ATTACK, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	db 41, JYNX,       TWISTEDSPOON, DOUBLESLAP, LOVELY_KISS, ICE_PUNCH, PSYCHIC_M
	db 41, EXEGGUTOR,  TWISTEDSPOON, REFLECT, LEECH_SEED, EGG_BOMB, PSYCHIC_M
	db 41, SLOWBRO,    TWISTEDSPOON, CURSE, AMNESIA, BODY_SLAM, PSYCHIC_M
	db 42, WOBBUFFET,  TWISTEDSPOON, COUNTER, MIRROR_COAT, SAFEGUARD, DESTINY_BOND
	db 43, WYRDEER,    TWISTEDSPOON, PSYCHIC_M, CONFUSE_RAY, HYPNOSIS, BITE
	db -1 ; end
...
BrunoGroup:
	...
	db 42, HITMONTOP,  BLACKBELT,    PURSUIT, QUICK_ATTACK, DIG, DETECT
	db 42, HITMONLEE,  BLACKBELT,    SWAGGER, DOUBLE_KICK, HI_JUMP_KICK, FORESIGHT
	db 42, HITMONCHAN, BLACKBELT,    THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	db 43, HERCULASH,  BLACKBELT,    MEGAHORN, CROSS_CHOP, THIEF, DETECT
	db 44, POLIWRATH,  BLACKBELT,    HYPNOSIS, SURF, MIND_READER, DYNAMICPUNCH
	db 46, MACHAMP,    BLACKBELT,    ROCK_SLIDE, FORESIGHT, VITAL_THROW, CROSS_CHOP
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_ITEM_MOVES
	db 42, UMBREON,    BLACKGLASSES, SAND_ATTACK, CONFUSE_RAY, FAINT_ATTACK, MEAN_LOOK
	db 43, WEAVILE,    BLACKGLASSES, STUN_SPORE, ACID, MOONLIGHT, PETAL_DANCE
	db 44, GENGAR,     BLACKGLASSES, LICK, SPITE, CURSE, DESTINY_BOND
	db 45, KELPIQUUS,  BLACKGLASSES, FAINT_ATTACK, HYDRO_PUMP, AGILITY, SMOKESCREEN
	db 46, BELLRAUNE,  BLACKGLASSES, SYNTHESIS, SLEEP_POWDER, CRUNCH, PETAL_DANCE
	db 47, HOUNDOOM,   BLACKGLASSES, ROAR, PURSUIT, FLAMETHROWER, CRUNCH
	db -1 ; end

KogaGroup:
	; KOGA (1)
	db "KOGA@", TRAINERTYPE_ITEM_MOVES
	db 40, ARIADOS,    POISON_BARB,  DOUBLE_TEAM, SPIDER_WEB, BATON_PASS, GIGA_DRAIN
	db 41, VENOMOTH,   POISON_BARB,  SUPERSONIC, GUST, PSYCHIC_M, TOXIC
	db 43, FORRETRESS, POISON_BARB,  PROTECT, SWIFT, EXPLOSION, SPIKES
	db 42, MUK,        POISON_BARB,  MINIMIZE, ACID_ARMOR, SLUDGE_BOMB, TOXIC
	db 43, NIDOKING,   POISON_BARB,  TOXIC, FIRE_PUNCH, SLUDGE_BOMB, ICE_PUNCH 
	db 44, CROBAT,     POISON_BARB,  DOUBLE_TEAM, QUICK_ATTACK, WING_ATTACK, TOXIC
	db -1 ; end

ChampionGroup:
	; CHAMPION (1)
	db "LANCE@", TRAINERTYPE_ITEM_MOVES
	db 44, GYARADOS,   DRAGON_SCALE, FLAIL, RAIN_DANCE, SURF, HYPER_BEAM
	db 47, TROPIPOD,   DRAGON_SCALE, SUNNY_DAY, DRAGONBREATH, SOLARBEAM, HYPER_BEAM
	db 47, KINGDRA,    DRAGON_SCALE, HYDRO_PUMP, DRAGONBREATH, BLIZZARD, HYPER_BEAM
	db 46, AERODACTYL, DRAGON_SCALE, WING_ATTACK, ANCIENTPOWER, ROCK_SLIDE, HYPER_BEAM
	db 46, T_NEPRES,   DRAGON_SCALE, SLUDGE_BOMB, DRAGONBREATH, CRUNCH, HYPER_BEAM
	db 50, DRAGONITE,  DRAGON_SCALE, FIRE_BLAST, SAFEGUARD, OUTRAGE, HYPER_BEAM
	db -1 ; end

BrockGroup:
	; BROCK (1)
	db "BROCK@", TRAINERTYPE_ITEM_MOVES
	db 51, GOLEM,      HARD_STONE,   DEFENSE_CURL, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db 51, RHYPERIOR,  HARD_STONE,   FURY_ATTACK, SCARY_FACE, EARTHQUAKE, HORN_DRILL
	db 52, CORSOLA,    HARD_STONE,   ANCIENTPOWER, RECOVER, MIRROR_COAT, AMNESIA
	db 52, ONIX,       HARD_STONE,   ROCK_SLIDE, EARTHQUAKE, IRON_TAIL, SANDSTORM
	db 53, LYPRESS,    HARD_STONE,   ROCK_SLIDE, SLAM, FAINT_ATTACK, MIMIC
	db 54, KLEAVOR,    HARD_STONE,   FURY_CUTTER, ROCK_THROW, SLASH, SWORDS_DANCE
	db -1 ; end

MistyGroup:
	; MISTY (1)
	db "MISTY@", TRAINERTYPE_ITEM_MOVES
	db 47, POLITOED,   MYSTIC_WATER, SURF, PERISH_SONG, HYPNOSIS, HYDRO_PUMP
	db 47, QUAGSIRE,   MYSTIC_WATER, SURF, AMNESIA, EARTHQUAKE, RAIN_DANCE
	db 49, LANTURN,    MYSTIC_WATER, SURF, CONFUSE_RAY, THUNDER, THUNDER_WAVE
	db 49, LAPRAS,     MYSTIC_WATER, SURF, PERISH_SONG, BLIZZARD, RAIN_DANCE
	db 50, NORWHOL,    MYSTIC_WATER, SURF, ICE_BEAM, REST, SLEEP_TALK
	db 52, STARMIE,    MYSTIC_WATER, SURF, CONFUSE_RAY, RECOVER, ICE_BEAM
	db -1 ; end

LtSurgeGroup:
	; LT_SURGE (1)
	db "LT.SURGE@", TRAINERTYPE_ITEM_MOVES
	db 49, RAICHU,     MAGNET,      THUNDER_WAVE, QUICK_ATTACK, THUNDERBOLT, THUNDER
	db 48, JOLTEON,    MAGNET,      THUNDER_WAVE, AGILITY, PIN_MISSILE, THUNDERBOLT
	db 48, MAGNEZONE,  MAGNET,      LOCK_ON, DOUBLE_TEAM, SWIFT, ZAP_CANNON
	db 49, LECTROLITE, MAGNET,      SCREECH, DOUBLE_TEAM, SWIFT, EXPLOSION
	db 51, ELECTABUZZ, MAGNET,      QUICK_ATTACK, THUNDERPUNCH, LIGHT_SCREEN, THUNDER
	db 52, ELECTIVIRE, MAGNET,      ICE_PUNCH, CROSS_CHOP, BARRIER, THUNDER
	db -1 ; end
...
ErikaGroup:
	...
	db 52, TANGROWTH,  MIRACLE_SEED, VINE_WHIP, BIND, GIGA_DRAIN, SLEEP_POWDER
	db 51, MEGANIUM,   MIRACLE_SEED, POISON_POWDER, LEECH_SEED, LIGHT_SCREEN, GIGA_DRAIN
	db 53, LEAFEON,    MIRACLE_SEED, RAZOR_LEAF, SAND_ATTACK, HYPER_BEAM, SUNNY_DAY
	db 54, BELLRAUNE,  MIRACLE_SEED, SUNNY_DAY, SYNTHESIS, CRUNCH, PETAL_DANCE
	db 56, VICTREEBEL, MIRACLE_SEED, SUNNY_DAY, SYNTHESIS, ACID, RAZOR_LEAF
	db 56, BELLOSSOM,  MIRACLE_SEED, SUNNY_DAY, SYNTHESIS, PETAL_DANCE, SOLARBEAM
	db -1 ; end
...
SchoolboyGroup:
	...
	db 35, LECTROLITE, SCREECH, SONICBOOM, ROLLOUT, LIGHT_SCREEN
	...
	db 32, TANGROWTH,  POISONPOWDER, VINE_WHIP, BIND, MEGA_DRAIN
	db 32, YANMEGA,    QUICK_ATTACK, DOUBLE_TEAM, SONICBOOM, SUPERSONIC
	...
	db 34, JYNX,       PSYCHIC_M, LIGHT_SCREEN, REFLECT, SWEET_KISS
	db 38, MAGNEZONE,  ZAP_CANNON, THUNDER_WAVE, LOCK_ON, SWIFT
	db -1 ; end
...
LassGroup:
	...
	db 18, PIKACHU,    QUICK_ATTACK, GROWL, THUNDERSHOCK, THUNDER_WAVE
	...
	; LASS (14)
	db "DANA@", TRAINERTYPE_MOVES
	db 21, PIKACHU,    QUICK_ATTACK, GROWL, THUNDERSHOCK, THUNDER_WAVE
	...
	db 29, RAICHU,     SLAM, THUNDERSHOCK, THUNDER_WAVE, AGILITY
	db -1 ; end

	; LASS (16)
	db "DANA@", TRAINERTYPE_MOVES
	db 32, PSYDUCK,    SCRATCH, DISABLE, CONFUSION, SCREECH
	db 32, RAICHU,     SLAM, THUNDERPUNCH, THUNDER_WAVE, AGILITY
	db -1 ; end

	; LASS (17)
	db "DANA@", TRAINERTYPE_MOVES
	db 36, RAICHU,     SLAM, THUNDERPUNCH, THUNDER_WAVE, AGILITY
...
JanineGroup:
	...
	db 49, CROBAT,     POISON_BARB,  SCREECH, SUPERSONIC, CONFUSE_RAY, WING_ATTACK
	db 49, QWILFISH,   POISON_BARB,  SURF, SLUDGE_BOMB, PIN_MISSILE, TOXIC
	db 50, VILEPLUME,  POISON_BARB,  PETAL_DANCE, TOXIC, SYNTHESIS, SLUDGE_BOMB
	db 51, GASSPING,   POISON_BARB,  PSYCHIC_M, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 48, NIDOQUEEN,  POISON_BARB,  EARTHQUAKE, SLUDGE_BOMB, FLAMETHROWER, ICE_BEAM
	db 52, VENOMOTH,   POISON_BARB,  FORESIGHT, DOUBLE_TEAM, GUST, PSYCHIC_M
	db -1 ; end

CooltrainerMGroup:
	; COOLTRAINERM (1)
	db "NICK@", TRAINERTYPE_MOVES
	db 26, CYNDAQUIL,  EMBER, SMOKESCREEN, QUICK_ATTACK, LEER
	db 26, TOTODILE,   LEER, WATER_GUN, BITE, SCARY_FACE
	db 26, CHIKORITA,  LEECH_SEED, POISONPOWDER, SLEEP_POWDER, RAZOR_LEAF
	db -1 ; end
	...
	db 27, QUILAVA, EMBER, SMOKESCREEN, QUICK_ATTACK, LEER
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 25, ARCANINE,  EMBER, EXTREMESPEED, ROAR, AGILITY
	db -1 ; end
	...
	db 32, FERALIGATR, BITE, LEER, SURF, RAIN_DANCE
	db -1 ; end

	; COOLTRAINERF (9)
	db "BETH@", TRAINERTYPE_MOVES
	db 34, SYLVEON,    WING_ATTACK, SWIFT, ATTRACT, CHARM
	db 36, ARCANINE,   CRUNCH, FLAME_WHEEL, EXTREMESPEED, AGILITY
	db -1 ; end
	...
	db 32, CHIKORITA,  GROWL, LEECH_SEED, POISONPOWDER, RAZOR_LEAF
	db 32, BAYLEEF,    GROWL, LEECH_SEED, POISONPOWDER, RAZOR_LEAF
	db 32, MEGANIUM,   BODY_SLAM, SLEEP_POWDER, RAZOR_LEAF, REFLECT
	db -1 ; end

	; COOLTRAINERF (12)
	db "BETH@", TRAINERTYPE_MOVES
	db 37, SYLVEON,    WING_ATTACK, SWIFT, ATTRACT, CHARM
	db 39, ARCANINE,   CRUNCH, FLAME_WHEEL, EXTREMESPEED, AGILITY
	db -1 ; end
	...
	db 42, SYLVEON,    PINK_BOW,     WING_ATTACK, HYPER_BEAM, ATTRACT, CHARM
	db 43, ARCANINE,   FOCUS_BAND,   CRUNCH, FLAME_WHEEL, EXTREMESPEED, FIRE_BLAST
	db -1 ; end
...
SabrinaGroup:
	...
	db 51, ESPEON,     TWISTEDSPOON, SAND_ATTACK, QUICK_ATTACK, SWIFT, PSYCHIC_M
	db 51, SLOWKING,   TWISTEDSPOON, AMNESIA, PSYCHIC_M, SURF, DISABLE
	db 49, WOBBUFFET,  TWISTEDSPOON, COUNTER, MIRROR_COAT, SAFEGUARD, DESTINY_BOND
	db 51, WYRDEER,    TWISTEDSPOON, HYPNOSIS, STOMP, CONFUSE_RAY, PSYCHIC_M
	db 52, DORMARE,    TWISTEDSPOON, HYPNOSIS, DREAM_EATER, NIGHTMARE, FUTURE_SIGHT
	db 53, ALAKAZAM,   TWISTEDSPOON, RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db -1 ; end
...
FisherGroup:
	...
	db 25, CHINCHOU,   THUNDER_WAVE, SPARK, SUPERSONIC, WATER_GUN
	db 25, CHINCHOU,   THUNDER_WAVE, SPARK, SUPERSONIC, WATER_GUN
	db -1 ; end
	...
	db 34, SEAKING,    SUPERSONIC, WATERFALL, FLAIL, FURY_ATTACK
	db 38, LANTURN,   CONFUSE_RAY, SPARK, SURF, TAKE_DOWN
	db -1 ; end
...
Rival2Group:
	...
	; RIVAL2 (4)
	db "?@", TRAINERTYPE_MOVES
	db 45, WEAVILE,    QUICK_ATTACK, SCREECH, FAINT_ATTACK, FURY_CUTTER
	db 48, CROBAT,     TOXIC, BITE, CONFUSE_RAY, WING_ATTACK
	db 45, MAGNEZONE,  THUNDER, SONICBOOM, THUNDER_WAVE, SWIFT
...
BlaineGroup:
	...
	db 55, MAGCARGO,   CHARCOAL,   CURSE, SMOG, FLAMETHROWER, ROCK_SLIDE
	db 55, ARCANINE,   CHARCOAL,   FLAME_WHEEL, EXTREMESPEED, DIG, DRAGONBREATH
	db 55, MAGMAR,     CHARCOAL,   THUNDERPUNCH, FIRE_PUNCH, SUNNY_DAY, CONFUSE_RAY
	db 57, TYPHLOSION, CHARCOAL,   FLAMETHROWER, SWIFT, DIG, THUNDERPUNCH
	db 58, WHELKANO,   CHARCOAL,   IRON_TAIL, FLAMETHROWER, ACID_ARMOR, FIRE_BLAST
	db 60, MAGMORTAR,  CHARCOAL,   THUNDERPUNCH, FLAMETHROWER, CONFUSE_RAY, FIRE_BLAST
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 33, WEEZING,    TACKLE, EXPLOSION, SLUDGE, SMOKESCREEN
	db 35, GASSPING,   PSYCHIC_M, SLUDGE_BOMB, SMOG, SMOKESCREEN
	db -1 ; end
...
PicnickerGroup:
	...
	db 36, GROWLITHE,  GROWL, BITE, FLAME_WHEEL, SUNNY_DAY
	...
	db 38, MEGANIUM,   SOLARBEAM, RAZOR_LEAF, HEADBUTT, MUD_SLAP
	db -1 ; end
...
ExecutiveFGroup:
	...
	db 32, BELLRAUNE,  VINE_WHIP, BITE, WRAP, SYNTHESIS
	db -1 ; end
	...
	db 25, WEEPINBELL, VINE_WHIP, BITE, WRAP, ACID
	db -1 ; end
...
PokefanMGroup:
	...
	db 29, CHIKORITA,  BERRY
	db 29, CYNDAQUIL,  BERRY
	db 29, TOTODILE,   BERRY
	db -1 ; end
...
RedGroup:
	...
	db 73, ESPEON,     TWISTEDSPOON, MUD_SLAP, REFLECT, SWIFT, PSYCHIC_M
	db 75, SNORLAX,    MINT_BERRY,   AMNESIA, SNORE, REST, BODY_SLAM
...
BlueGroup:
	...
	db 61, PIDGEOT,    SHARP_BEAK,   QUICK_ATTACK, WHIRLWIND, WING_ATTACK, MIRROR_MOVE
	db 59, ALAKAZAM,   TWISTEDSPOON, DISABLE, RECOVER, PSYCHIC_M, REFLECT
	db 61, RHYPERIOR,  SOFT_SAND,    FURY_ATTACK, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
