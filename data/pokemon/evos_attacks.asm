...
MagnetonEvosAttacks:
	db EVOLVE_ITEM, THUNDER_STONE, MAGNEZONE
	db 0 ; no more evolutions
	db 1, TACKLE
	db 1, THUNDERSHOCK
	db 1, SUPERSONIC
...
RhydonEvosAttacks:
	db EVOLVE_ITEM, KINGS_ROCK, RHYPERIOR
	db 0 ; no more evolutions
	db 1, HORN_ATTACK
	db 1, TAIL_WHIP
	db 1, STOMP
...
SeadraEvosAttacks:
	...
	db EVOLVE_HAPPINESS, TR_NITE, KELPIQUUS
	db 0 ; no more evolutions
	db 1, BUBBLE
	db 1, SMOKESCREEN
	db 1, LEER
...
ScytherEvosAttacks:
	...
	db EVOLVE_ITEM, HARD_STONE, KLEAVOR
	db 0 ; no more evolutions
	db 1, QUICK_ATTACK
	db 1, LEER
	db 6, FOCUS_ENERGY
...
ElectabuzzEvosAttacks:
	db EVOLVE_ITEM, THUNDER_STONE, ELECTIVIRE
	db 0 ; no more evolutions
	db 1, QUICK_ATTACK
	db 1, LEER
	db 1, THUNDERPUNCH
...
EeveeEvosAttacks:
	...
	db EVOLVE_ITEM, PINK_BOW, SYLVEON
...
TogeticEvosAttacks:
	db EVOLVE_ITEM, PINK_BOW, TOGEKISS
	db 0 ; no more evolutions
	db 1, GROWL
	db 1, CHARM
	db 7, METRONOME
...
SudowoodoEvosAttacks:
	db EVOLVE_ITEM, HARD_STONE, LYPRESS
	db 0 ; no more evolutions
	db 1, ROCK_THROW
	db 1, MIMIC
	db 10, FLAIL
...
PiloswineEvosAttacks:
	db EVOLVE_ITEM, NEVERMELTICE, MAMOSWINE
	db 0 ; no more evolutions
	db 1, HORN_ATTACK
	db 1, POWDER_SNOW
	db 1, ENDURE
...
Porygon2EvosAttacks:
	db EVOLVE_ITEM, UP_GRADE, PORYGONZ
	db 0 ; no more evolutions
	db 1, CONVERSION2
	db 1, TACKLE
	db 1, CONVERSION
