...
MonMenuIcons:
	...
	db ICON_SERPENT     ; DUDUNSPARS
	db ICON_BUG         ; PERISHROOM
	...
	db ICON_SUDOWOODO   ; LYPRESS
	db ICON_HUMANSHAPE  ; DORMARE
	...
	db ICON_BUG         ; HERCULASH
	db ICON_VOLTORB     ; LECTROLITE
	db ICON_BLOB        ; WHELKANO
	db ICON_SERPENT     ; DRATINI
	db ICON_SERPENT     ; DRAGONAIR
	db ICON_BIGMON      ; DRAGONITE
	db ICON_SERPENT     ; T_NEPRES
	db ICON_LAPRAS      ; NORWHOL
