...
DEF GOLDENRODGAMECORNER_PIKACHU_COINS   EQU 500
DEF GOLDENRODGAMECORNER_CHANSEY_COINS   EQU 1500
DEF GOLDENRODGAMECORNER_PORYGON_COINS   EQU 5500
...
.Chansey:
	checkcoins GOLDENRODGAMECORNER_CHANSEY_COINS
	ifequal HAVE_LESS, GoldenrodGameCornerPrizeVendor_NotEnoughCoinsScript
	readvar VAR_PARTYCOUNT
	ifequal PARTY_LENGTH, GoldenrodGameCornerPrizeMonVendor_NoRoomForPrizeScript
	...
	special GameCornerPrizeMonCheckDex
	givepoke CHANSEY, 15
	takecoins GOLDENRODGAMECORNER_CHANSEY_COINS
	sjump .loop
